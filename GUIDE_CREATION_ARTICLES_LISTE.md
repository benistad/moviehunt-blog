...
<div class="film-carousel" style="display: flex; gap: 10px; overflow-x: auto; margin: 6px 0 10px; padding: 2px 0; scroll-snap-type: x mandatory;">
  ...
  <img src="https://image.tmdb.org/t/p/original/BACKDROP3.jpg" alt="Titre du Film (Année) — [mot-clé SEO principal de l'article]" style="height: 300px; width: auto; border-radius: 8px; flex-shrink: 0; scroll-snap-align: start;" loading="lazy" decoding="async" />
</div>
