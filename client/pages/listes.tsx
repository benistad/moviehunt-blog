...
export default function Listes({ initialArticles = [], totalPages: initialTotalPages = 1 }: Partial<ListesProps>) {
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="mb-10">
          <div className="flex items-center gap-3 mb-3">
            <div className="bg-orange-500 text-white px-5 py-2.5 rounded-full font-bold text-xl">
              📋 Listes de films
            </div>
          </div>
          <p className="text-gray-600 text-lg">Sélections et tops de films à découvrir</p>
        </div>
        ...
        {loading ? (
          ...
          <div className="text-center py-20 bg-white rounded-xl shadow-md">
            <p className="text-gray-600 text-lg">Aucune liste trouvée</p>
          </div>
        ) : (
          <>
