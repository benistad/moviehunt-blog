...
export default function HeroArticle({ article }) {
  ...
  const getCategoryBadge = () => {
    if (article.category === 'list') {
      return (
        <span className="inline-flex items-center px-4 py-2 bg-accent-orange text-white rounded-full font-semibold text-sm shadow-lg">
          📋 Liste
        </span>
      );
    }
  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0">
        ...
        {/* Gradient Overlay - Dark blue/purple gradient like the mockup */}
      ...
      <div className="relative z-10 p-8 md:p-10 h-full flex flex-col justify-between min-h-[500px]">
        ...
        <div className="space-y-4">
          ...
          {/* Title */}
          <h2 className="text-3xl md:text-4xl font-bold text-white leading-tight group-hover:text-accent-orange transition-colors duration-300">
            {article.title}
          </h2>
          ...
          <div className="flex items-center justify-between pt-4">
            ...
            <button className="inline-flex items-center px-6 py-2 bg-white text-gray-900 rounded-lg font-medium hover:bg-accent-orange hover:text-white transition-all duration-300 shadow-lg group-hover:shadow-xl">
              Lire la critique →
            </button>
          </div>
        </div>
